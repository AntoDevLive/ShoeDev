...
<body>
  ...
  <!-- Imagen y username -->
  <section class="bg-neutral-50 flex justify-center items-center gap-4 p-10">
    ...
    <div class="flex justify-center items-center gap-4">
      <h2 class="text-5xl font-semibold capitalize"><?php echo $_SESSION['username'] ?></h2>

      <!-- Botones editar y guardar -->
      <button class="bg-yellow-600 p-1 rounded-full cursor-pointer transition-all duration-200 hover:bg-yellow-600/80">
  ...
  <section class="flex justify-center items-center flex-col gap-4 bg-neutral-100 p-10">
    ...
    <form class="disabled w-150 py-12 px-8 bg-orange-50 flex flex-col gap-5 justify-center items-center shadow-xl rounded-lg" action="/shoedev/backend/">
      <fieldset class="grid grid-cols-2 w-full gap-5">
        <input class="bg-white border border-orange-300 p-1.5 text-xl rounded-md w-full" type="email" placeholder="Email" value="<?php echo $usuario['email'] ?>">
        <input class="bg-white border border-orange-300 p-1.5 text-xl rounded-md w-full" type="text" placeholder="Nombre" value="<?php echo $usuario['nombre'] ?>">
        <input class="bg-white border border-orange-300 p-1.5 text-xl rounded-md w-full" type="text" placeholder="Apellidos" value="<?php echo $usuario['apellidos'] ?>">
        <input class="bg-white border border-orange-300 p-1.5 text-xl rounded-md w-full" type="text" placeholder="Dirección" value="<?php echo $usuario['direccion'] ?>">
      </fieldset>
      <input class="bg-white border border-orange-300 p-1.5 text-xl rounded-md w-full" type="date" placeholder="Nacimiento" value="<?php echo $usuario['nacimiento'] ?>">
