  ...
  <section class="py-8">
    ...
    <div class="flex justify-center items-center flex-col gap-2 w-full">
      ...
      <div class="w-full flex justify-center items-center gap-10">
        <button class="py-2 px-5 rounded-md border border-gray-400 cursor-pointer duration-200 transition-all hover:bg-orange-600 hover:text-white">Más recientes primero</button>
        <button class="py-2 px-5 rounded-md border border-gray-400 cursor-pointer duration-200 transition-all hover:bg-orange-600 hover:text-white">Más antiguos primero</button>
        <button class="py-2 px-5 rounded-md border border-gray-400 cursor-pointer duration-200 transition-all hover:bg-orange-600 hover:text-white">Administradores</button>
        <button class="py-2 px-5 rounded-md border border-gray-400 cursor-pointer duration-200 transition-all hover:bg-orange-600 hover:text-white">Usuarios estándar</button>
      </div>
    </div>
        ...
        <tbody class="divide-y divide-gray-200 bg-white text-center">
          ...
          <?php foreach ($usuarios as $user): ?>
            <tr class="hover:bg-orange-50 transition">
              ...
              <td class="py-3 px-4"><?php echo $user['nombre']; ?></td>
              <td class="py-3 px-4"><?php echo $user['apellidos']; ?></td>
              <td class="py-3 px-4"><?php echo $user['direccion']; ?></td>
              <td class="py-3 px-4"><?php echo $user['nacimiento']; ?></td>
              <td class="py-3 px-4">
                <span class="bg-orange-100 text-orange-700 px-2 py-1 rounded-full text-xs font-semibold"><?php echo $user['rol']; ?></span>
              </td>
              <td class="py-3 px-4">
                <div class="flex gap-3 justify-center">
                  <button class="px-3 py-1 text-sm bg-blue-500 hover:bg-blue-600 text-white rounded-md transition">Editar</button>
                  <button class="px-3 py-1 text-sm bg-red-500 hover:bg-red-600 text-white rounded-md transition">Eliminar</button>
                </div>
              </td>
            </tr>
          <?php endforeach; ?>
