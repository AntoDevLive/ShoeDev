<header id="inicio" class="bg-white/70 backdrop-blur-xl <?php if (basename($_SERVER['SCRIPT_NAME']) === 'tienda.php') echo 'fixed mb-50 w-full z-10 shadow-md shadow-black/30' ?> ">
                            ...
                            <section class="user-menu flex justify-center items-center flex-col text-xl user-submenu absolute bg-slate-700 text-white w-50 rounded-lg overflow-hidden opacity-0 pointer-events-none transition-all duration-300">
                                ...
                                <nav class="w-full">
                                    <ul class="text-[1.05rem]">
                                        ...
                                        <li class="w-full">
                                            <a class="transition-all duration-300 hover:bg-slate-600 flex items-center gap-2 py-1.5 px-4" href="/shoedev/backend/config/cerrar.php">
