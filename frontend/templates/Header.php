            ...
            <div class="container mx-auto px-4 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <a href="#" class="text-sm font-medium text-gray-500 hover:text-orange-600 transition">Contacto</a>
                        ...
                        <a id="carrito-btn" class="cursor-pointer flex items-center gap-2 bg-sky-600 text-white px-4 py-2 rounded hover:bg-sky-500 transition">
