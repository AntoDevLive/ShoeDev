        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <?php if ($_SERVER['REQUEST_URI'] !== '/shoedev/login.php'):  ?>
                    ...
                    <button id="carrito-btn" class="cursor-pointer flex items-center gap-2 bg-orange-600 text-white p-2 rounded-full hover:bg-orange-500 transition">
